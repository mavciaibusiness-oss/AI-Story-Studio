    ...
    v.onloadedmetadata = () => {
      const info = {
        ...
        /*
          ...
          Tarayıcılarda standart bir "bu videonun ses kanalı var
          mı" API'si yok. Üç tarayıcıya özel alan var; hiçbiri
          yoksa `null` bırakıyoruz — `false` DEĞİL.

          Fark önemli: `false` "ses yok" demek, `null` "bilmiyoruz"
          demek. Bilmediğimizde ses kategorisini ölçülmemiş sayıp
          kullanıcıdan istiyoruz; sessiz diye damgalamıyoruz.
        */
        hasAudio: (() => {
