...
export function planSceneSplit(text, currentDur) {
  ...
  /* Bölme birimleri: normalde cümleler. Bir cümle tek başına hedef
     üst sınırı aşıyorsa o cümle öbeklerine ayrılır — yoksa parça
     büyük kalır ve bölmenin amacı kaybolur. */
  const units = [];
